...
def purchase_confirmation(invoice,amount,customer_email):
    ...
    msg = Message('Swap - Payment Successful', sender=sender, recipients=[recipient,admin])
    msg.html=render_template('email/purchase.html', user=current_user,invoice=invoice,amount=amount,
