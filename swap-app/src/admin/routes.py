...
def dashboard():
    if is_admin():
        ...
        return render_template('admin/dashboard.html',title="Admin Page",products=products)
...
def dashboard_orders():
    ...
    if is_admin():
        ...
        return render_template('admin/orders.html',title="Admin Page",orders=orders)
...
def update_orders(id):
    ...
    return render_template('admin/update_orders.html',title="Admin Page",orders=orders)
...
def dashboard_users(name=''):
    ...
    if name == 'admin':
        return render_template('admin/users.html',title="Admin Page",admins=admins)  
    else:
        return render_template('admin/users.html',title="Admin Page",customers=customers)
...
def apparels():
    ...
    return render_template('admin/products.html',title="Apparel Page",apparels=apparels) 
...
def categories():
    ...
    return render_template('admin/products.html',title="category Page",categories=categories)
